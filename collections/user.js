...
const users = {
    ...
    generateUsers: async function() {
        ...
        try {
            ...
            let users_collection = db.collection("users");
            for (let userCreate = 0; userCreate < process.env.CREATE_USER; userCreate++) {
                ...
                let userField = {
                    ...
                    password: await users.createCryptPass(userData.results[0].login.password),
                    ...
                    history: [ {
                        ...
                        startPosition: {latitude: getRandomInt(40), longitude: getRandomInt(50)},
                        endPosition: {latitude: getRandomInt(40), longitude: getRandomInt(50)},
